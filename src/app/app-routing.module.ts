...
//       {path:':id',component: ServerComponent, resolve: {server: ServerResolver}}//children routes load karanna wenama 
...
//         //RouterModule.forRoot(appRouts, {useHash: true})//hash mode routing http://localhost:4200/#/servers
//         //web server eka care karanne # tag eken wam paththa witharai,
//         //ehema nathi welawata servers kiyana kallath wev server eka tyeda valanawa eka tynne angular ekata bala
//         //ganna nisa web server eka 404 error ekak enawaa
//     ],
